...
const filteredSchools = computed(() => {
  ...
  return batteryStore.schoolsRanked.filter(school => 
  ...
  <div class="min-h-screen bg-gray-100">
    <header class="bg-blue-600 text-white py-8">
      <div class="max-w-7xl mx-auto px-6">
        ...
        <p class="text-blue-100 mb-6">Monitor school tablet batteries and prioritize replacements</p>
    ...
    <main class="max-w-7xl mx-auto px-6 py-6">
      ...
      <div v-else-if="batteryStore.error" class="flex flex-col items-center justify-center min-h-[200px] text-center">
        <p class="text-gray-600 mb-4">{{ batteryStore.error }}</p>
        <button @click="batteryStore.fetchSchools" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
          Retry
        </button>
      </div>
      
      <div v-else-if="filteredSchools.length === 0" class="flex items-center justify-center min-h-[200px]">
