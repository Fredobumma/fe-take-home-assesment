...
<template>
  <div class="min-h-screen bg-gray-100">
    <header class="bg-blue-600 text-white p-6">
      <button
        @click="goBack"
        class="bg-white text-gray-700 rounded-2xl hover:text-white mb-10 flex items-center gap-2"
      >
    ...
    <main class="max-w-7xl mx-auto px-6 py-6">
      ...
      <div
        v-else-if="!batteryStore.selectedSchool"
              ...
              <button
                ...
                :class="
                  filterStatus === 'all'
                    ...
                    : 'bg-white text-gray-700 border border-gray-300 hover:text-white hover:bg-blue-400'
                "
              >
                All
              </button>
        ...
        >
          <div class="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto p-6">
            <div class="flex justify-between items-center mb-4 gap-5">
              ...
              <button
                @click="closeChart"
                class="text-2xl pt-0.5 pb-1 px-3 rounded-full bg-red-500 hover:bg-red-700"
              >
                ×
              </button>
            </div>
            <BatteryChart :records="batteryData" :serialNumber="selectedDevice" />
          </div>
        </div>
      </div>
    </main>
